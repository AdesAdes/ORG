...
<head>
 ...
 <div class="col-sm-6 col-md-4">
        ...
        <div class="profile-header-container btn_add" role="button"
            data-toggle="modal" data-target="#addCiudades">
            <img class="img-circle" src="images/add_centros_regionales.jpg" alt="" id="profile"/>
            <div class="rank-label-container">
                <span class='badge alert-info'>Agregar Ciudades</div>
            </div>
        </div>
    </div>
  <br>
...
<table id="example" class="table table-striped table-bordered table-hover" >
        ...
        ?>      
            ...
            data-target="#viewMoreCiudades" data-id = <?php echo $CODIGO_LOCALIZACION; ?> >
                
                <td><img class="img-circle"
                    src="images/profile/$image" id="profile3"/>&nbsp &nbsp &nbsp
                    <?php echo $NOMBRE_CIUDAD; ?></td>
...
<?php require_once 'modalsCiudades.php'; ?>
</html>
