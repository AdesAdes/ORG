    ...
    <body id="login">
        <div class="container well" id="container-login">
            ...
            <form class="login" method="POST" action="validateLogin.php"
                ...
                <button class="btn btn-lg btn-success btn-block" id="startSession" type="submit">Iniciar sesión</button>
                <div class="checkbox">
        ...
        <script type="text/javascript">
            ...
            function start() {
                document.getElementById("formLogin").addEventListener('submit', validate, false);
            }
