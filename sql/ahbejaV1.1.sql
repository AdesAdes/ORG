...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 11-11-2015 a las 04:52:38
...
INSERT INTO `tbl_clases` (`CODIGO_CLASE`, `NOMBRE_CLASE`, `REQUISITO`, `UV`, `CODIGO`) VALUES
(1, 'Japones 1', 0, 0, ''),
(2, 'Japones 2', 1, 0, ''),
(3, 'Japones 3', 2, 0, ''),
(4, 'Japones 4', 3, 0, ''),
...
(7, 'Japones 7', 6, 0, ''),
(8, 'Japones 8', 7, 0, ''),
(10, 'MATEMATICA I', 0, 5, 'MM110'),
(11, 'INTROD. A LA ING. EN SISTEMAS', 0, 3, 'IS110'),
(12, 'GUITARRA POPULAR', 0, 3, 'RR156'),
(13, 'INGLES I', 0, 4, 'IN101'),
(14, 'BASE DE DATOS II', 0, 4, 'IS602');
...
CREATE TABLE IF NOT EXISTS `tbl_horarios` (
  ...
  `HORA_ESTABLECIDA` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_personas` (`CODIGO_PERSONA`, `NOMBRE`, `APELLIDO`, `TEL_MOVIL`, `TEL_FIJO`, `CORREO_ELECTRONICO`, `NUMERO_IDENTIDAD`, `FECHA_NACIMIENTO`, `GENERO`, `CODIGO_LOCALIZACION`, `CODIGO_ROL`) VALUES
(1, 'DANNY OMAR', 'ESTEBAN ELVIR', 31548954, 22556677, 'danyoel@unah.hn', 2147483647, '1992-11-07', 'M', 0, 0);
...
('jonie', 'QXNkLjEyMzQ=', '2015-09-08 00:00:00', '2015-09-17 00:00:00', '2015-09-13 00:24:32', 1, '3', 0),
...
ALTER TABLE `tbl_matriculas`
  ADD PRIMARY KEY (`CODIGO_MATRICULA`), ADD KEY `CODIGO_HISTORIALES_FK` (`CODIGO_HISTORIAL`), ADD KEY `CODIGO_PERIODOS_FK` (`CODIGO_PERIODO`), ADD KEY `CODIGO_PERSONAS_NFK_FK` (`CODIGO_PERSONA`), ADD KEY `CODIGO_SECCIONES_FK` (`CODIGO_SECCION`);
...
ALTER TABLE `tbl_personas`
  ADD PRIMARY KEY (`CODIGO_PERSONA`), ADD KEY `CODIGO_LOCALIZACIONES_FK` (`CODIGO_LOCALIZACION`), ADD KEY `CODIGO_ROLES_FK` (`CODIGO_ROL`);
...
ALTER TABLE `tbl_secciones`
  ADD PRIMARY KEY (`CODIGO_SECCION`), ADD KEY `CODIGO_AULAS_FK` (`CODIGO_AULA`), ADD KEY `CODIGO_CLASES_FK` (`CODIGO_CLASE`), ADD KEY `CODIGO_HORARIOS_FK` (`CODIGO_HORARIO`), ADD KEY `CODIGO_PERIODOS_NFK_FK` (`CODIGO_PERIODO`);
...
--
ALTER TABLE `accesos_de_usuario`
  MODIFY `iden` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=89;
--
...
--
ALTER TABLE `tbl_centros_regionales`
  MODIFY `CODIGO_CENTRO_REGIONAL` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
-- AUTO_INCREMENT de la tabla `tbl_clases`
--
ALTER TABLE `tbl_clases`
  MODIFY `CODIGO_CLASE` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=15;
--
...
--
ALTER TABLE `tbl_localizaciones`
  MODIFY `CODIGO_LOCALIZACION` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tbl_personas`
  MODIFY `CODIGO_PERSONA` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `tbl_usuarios`
ADD CONSTRAINT `CODIGO_PERSONAS_NFK1_FK` FOREIGN KEY (`CODIGO_PERSONA`) REFERENCES `tbl_personas` (`CODIGO_PERSONA`);
