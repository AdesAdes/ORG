...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-11-2015 a las 04:54:42
...
INSERT INTO `tbl_clases` (`CODIGO_CLASE`, `NOMBRE_CLASE`, `REQUISITO`, `UV`) VALUES
(1, 'Japones 1', 0, 0),
(2, 'Japones 2', 1, 0),
(3, 'Japones 3', 2, 0),
(4, 'Japones 4', 3, 0),
...
--
ALTER TABLE `accesos_de_usuario`
  MODIFY `iden` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=82;
--
...
--
ALTER TABLE `tbl_centros_regionales`
  MODIFY `CODIGO_CENTRO_REGIONAL` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=5;
--
